...
The `--gpudelay` flag injects random delays (1-100ms) into approximately 10% of GPU kernel launches. This is useful for:
...
[GPU 12345755ms] Kernel complete: kernel_softmax
```
